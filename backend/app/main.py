...
# Import routers
from app.routers import auth, services, bookings, gallery, testimonials, products as public_products, promo_codes as public_promo_codes, reviews as public_reviews, cart, wishlist, classes, site_settings as public_site_settings, whatsapp as whatsapp_router, categories as public_categories
from app.api.routes import brands, categories, products, product_images, product_variants, service_packages, orders
from app.api.routes.admin import locations as admin_locations, calendar as admin_calendar, bookings as admin_bookings, gallery as admin_gallery, users as admin_users, testimonials as admin_testimonials, promo_codes as admin_promo_codes, analytics as admin_analytics, booking_analytics, classes as admin_classes, site_settings as admin_site_settings, storage_settings as admin_storage_settings, instagram_settings as admin_instagram_settings, orders as admin_orders
...
app.include_router(admin_orders.router, prefix="/api")  # Admin order management API
