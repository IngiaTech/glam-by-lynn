/**
 * Services catalog — the interactive half of /services.
 *
 * Packages are fetched by the server component in `page.tsx` and handed over as
 * props, so the listing is present in the initial HTML for crawlers and social
 * unfurlers. This component owns only the interactions (navigation, WhatsApp).
 */
...
interface ServicesCatalogProps {
  ...
  /** Set when the server fetch failed, so the page degrades instead of 500ing. */
  error?: string | null;
}

export default function ServicesCatalog({ packages, error = null }: ServicesCatalogProps) {
