...
export default function NewServicePackage() {
  ...
  const handlePackageTypeChange = (newType: string) => {
    // Reset pricing fields when changing package type
    setFormData({
      ...formData,
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-foreground">Create Service Package</h1>
        <p className="text-muted-foreground mt-1">Build a new service package with dynamic pricing</p>
      </div>
