...
export default function NewGalleryPost() {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-foreground">Upload Gallery Media</h1>
        <p className="text-muted-foreground mt-1">Add a new image or video to your portfolio</p>
      </div>
